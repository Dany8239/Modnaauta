...
public class JJBlockBlock extends AutaModElements.ModElement {
	@ObjectHolder("auta:jj_block")
	public static final Block block = null;
	public JJBlockBlock(AutaModElements instance) {
		super(instance, 3);
	}
