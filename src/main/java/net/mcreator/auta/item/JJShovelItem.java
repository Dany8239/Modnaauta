...
public class JJShovelItem extends AutaModElements.ModElement {
	@ObjectHolder("auta:jj_shovel")
	public static final Item block = null;
	public JJShovelItem(AutaModElements instance) {
		super(instance, 10);
	}
