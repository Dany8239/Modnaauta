...
public class JJSwordItem extends AutaModElements.ModElement {
	@ObjectHolder("auta:jj_sword")
	public static final Item block = null;
	public JJSwordItem(AutaModElements instance) {
		super(instance, 9);
	}
